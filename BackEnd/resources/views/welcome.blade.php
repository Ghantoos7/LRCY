    ...
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="main" role="tabpanel" aria-labelledby="main-tab">
                ...
                <div>
                    <p>All of the unit tests for the User, Event, Post, and Admin controllers have been generated by
                        Laravel and have passed Laravel's testing suite. These tests were specifically made in Laravel and
                        are a part of the LRCY Project API Documentation. The purpose of unit testing is to verify that each
                        unit of code works as expected and to catch any bugs or errors early in the development process.
                        These tests were created to ensure that the APIs are functioning as intended and to catch any issues
                        before they can affect users.</p>
                    <div class="api-card">
                    ...
                    <div class="api-card">
                        <h2>Admin Controller (Tests\Unit\AdminController)</h2>
                        <ul>
                            <li class="success">Admin login api</li>
                            <li class="success">Logout api</li>
                            <li class="success">Add user api</li>
                            <li class="success">Edit user api</li>
                            <li class="success">Delete user api</li>
                            <li class="success">Get requests api</li>
                            <li class="success">Accept request api</li>
                            <li class="success">Decline request api</li>
                            <li class="success">Send announcement api</li>
                            <li class="success">Delete announcement api</li>
                            <li class="success">Edit announcement api</li>
                            <li class="success">Add event api</li>
                            <li class="success">Edit event api</li>
                            <li class="success">Delete event api</li>
                            <li class="success">Set yearly goal api</li>
                            <li class="success">Edit yearly goal api</li>
                            <li class="success">Delete yearly goal api</li>
                            <li class="success">Add training for user api</li>
                            <li class="success">Delete training for user api</li>
                            <li class="success">Add image to event api</li>
                            <li class="success">Remove image from event api</li>
                        </ul>
                    </div>
